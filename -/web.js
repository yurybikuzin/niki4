...
var $;
(function ($) {
    class $niki4 extends $.$mol_view {
        sub() {
            return [].concat(this.FractionAInput(), this.OpInput(), this.FractionBInput(), this.Eq0(), this.FractionALCM(), this.OpOutput(), this.FractionBLCM(), this.Eq1(), this.FractionLCM(), this.Eq2(), this.FractionRC(), this.Eq3(), this.FractionResult());
        }
        FractionAInput() {
            return ((obj) => {
                obj.nominator = (val) => this.a_nominator(val);
                obj.denominator = (val) => this.a_denominator(val);
                return obj;
            })(new this.$.$niki4_fraction_input);
        }
        a_nominator(val, force) {
            return (val !== void 0) ? val : 1;
        }
        a_denominator(val, force) {
            return (val !== void 0) ? val : 1;
        }
        op_title() {
            return this.OpInput().title();
        }
        OpInput() {
            return ((obj) => {
                return obj;
            })(new this.$.$niki4_op_input);
        }
        FractionBInput() {
            return ((obj) => {
                obj.nominator = (val) => this.b_nominator(val);
                obj.denominator = (val) => this.b_denominator(val);
                return obj;
            })(new this.$.$niki4_fraction_input);
        }
        b_nominator(val, force) {
            return (val !== void 0) ? val : 1;
        }
        b_denominator(val, force) {
            return (val !== void 0) ? val : 1;
        }
        Eq0() {
            return ((obj) => {
        ...
        FractionALCM() {
            return ((obj) => {
                obj.nominator = () => this.a_bis_nominator();
                obj.denominator = () => this.lcm();
                return obj;
            })(new this.$.$niki4_fraction_output);
        }
        a_bis_nominator(val, force) {
            return (val !== void 0) ? val : 1;
        }
        OpOutput() {
            return ((obj) => {
                obj.title = () => this.op_title();
                return obj;
            })(new this.$.$niki4_op_output);
        }
        FractionBLCM() {
            return ((obj) => {
                obj.nominator = () => this.b_bis_nominator();
                obj.denominator = () => this.lcm();
                return obj;
            })(new this.$.$niki4_fraction_output);
        }
        b_bis_nominator(val, force) {
            return (val !== void 0) ? val : 1;
        }
        Eq1() {
            return ((obj) => {
        ...
        FractionLCM() {
            return ((obj) => {
                obj.a = () => this.a_bis_nominator();
                obj.op = () => this.op_title();
                obj.b = () => this.b_bis_nominator();
                obj.lcm = () => this.lcm();
                return obj;
            })(new this.$.$niki4_fraction_lcm);
        }
        Eq2() {
            return ((obj) => {
                return obj;
        ...
        FractionRC() {
            return ((obj) => {
                obj.nominator = () => this.a_op_b_nominator();
                obj.denominator = () => this.lcm();
                return obj;
            })(new this.$.$niki4_fraction_output);
        }
        ...
        FractionResult() {
            return ((obj) => {
                obj.nominator = () => this.result_nominator();
                obj.denominator = () => this.result_denominator();
                return obj;
            })(new this.$.$niki4_fraction_output);
        }
        result_nominator() {
    ...
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "FractionAInput", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "a_nominator", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "a_denominator", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "OpInput", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "FractionBInput", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "b_nominator", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "b_denominator", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "Eq0", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "FractionALCM", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "a_bis_nominator", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "OpOutput", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "FractionBLCM", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "b_bis_nominator", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "Eq1", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "FractionLCM", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "Eq2", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "FractionRC", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "Eq3", null);
    __decorate([
        $.$mol_mem
    ], $niki4.prototype, "FractionResult", null);
    $.$niki4 = $niki4;
})($ || ($ = {}));
(function ($) {
    class $niki4_op_input extends $.$mol_check {
    }
    $.$niki4_op_input = $niki4_op_input;
})($ || ($ = {}));
(function ($) {
    class $niki4_op_output extends $.$mol_view {
        sub() {
            return [].concat(this.title());
        }
        title() {
    ...
    $.$niki4_op_output = $niki4_op_output;
})($ || ($ = {}));
(function ($) {
    class $niki4_eq extends $.$mol_view {
        sub() {
            return [].concat("=");
        }
    }
...
(function ($) {
    class $niki4_fraction_input extends $.$mol_view {
        nominator(val, force) {
            return (val !== void 0) ? val : 1;
        }
        denominator(val, force) {
            return (val !== void 0) ? val : 1;
        }
        dom_name() {
            return "table";
        ...
        sub() {
            return [].concat(this.NominatorRow(), this.DenominatorRow());
        }
        NominatorRow() {
            return ((obj) => {
                obj.dom_name = () => "tr";
                obj.sub = () => [].concat(this.NominatorCell());
                return obj;
            })(new this.$.$mol_view);
        }
        NominatorCell() {
            return ((obj) => {
                obj.dom_name = () => "td";
                obj.sub = () => [].concat(this.Nominator());
                return obj;
            })(new this.$.$mol_view);
        }
        Nominator() {
            return ((obj) => {
                obj.value = (val) => this.nominator(val);
                return obj;
            })(new this.$.$mol_string);
        }
        DenominatorRow() {
            return ((obj) => {
                obj.dom_name = () => "tr";
                obj.sub = () => [].concat(this.DenominatorCell());
                return obj;
            })(new this.$.$mol_view);
        }
        DenominatorCell() {
            return ((obj) => {
                obj.dom_name = () => "td";
                obj.sub = () => [].concat(this.Denominator());
                return obj;
            })(new this.$.$mol_view);
        }
        Denominator() {
            return ((obj) => {
                obj.value = (val) => this.denominator(val);
                return obj;
            })(new this.$.$mol_string);
        }
    }
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_input.prototype, "nominator", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_input.prototype, "denominator", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_input.prototype, "NominatorRow", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_input.prototype, "NominatorCell", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_input.prototype, "Nominator", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_input.prototype, "DenominatorRow", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_input.prototype, "DenominatorCell", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_input.prototype, "Denominator", null);
    $.$niki4_fraction_input = $niki4_fraction_input;
})($ || ($ = {}));
(function ($) {
    class $niki4_fraction_output extends $.$mol_view {
        nominator() {
            return 1;
        }
        denominator() {
    ...
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_output.prototype, "NominatorRow", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_output.prototype, "NominatorCell", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_output.prototype, "Nominator", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_output.prototype, "DenominatorRow", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_output.prototype, "DenominatorCell", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_output.prototype, "Denominator", null);
    $.$niki4_fraction_output = $niki4_fraction_output;
})($ || ($ = {}));
(function ($) {
    class $niki4_fraction_lcm extends $.$mol_view {
        a() {
            return 1;
        }
        op() {
        ...
        Nominator() {
            return ((obj) => {
                obj.sub = () => [].concat(this.a(), this.Op(), this.b());
                return obj;
            })(new this.$.$mol_view);
        }
        Op() {
            return ((obj) => {
                obj.sub = () => [].concat(this.op());
                return obj;
            })(new this.$.$mol_view);
        }
        DenominatorRow() {
    ...
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_lcm.prototype, "NominatorRow", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_lcm.prototype, "NominatorCell", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_lcm.prototype, "Nominator", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_lcm.prototype, "Op", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_lcm.prototype, "DenominatorRow", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_lcm.prototype, "DenominatorCell", null);
    __decorate([
        $.$mol_mem
    ], $niki4_fraction_lcm.prototype, "Denominator", null);
    $.$niki4_fraction_lcm = $niki4_fraction_lcm;
})($ || ($ = {}));
//niki4.view.tree.js.map
;
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
(function ($) {
    var $$;
    (function ($$) {
        class $niki4 extends $.$niki4 {
            a_nominator(val, force) {
                const result = this.$.$mol_state_session.value('a_nominator', val) || 0;
                return result;
            }
            a_denominator(val, force) {
                const result = this.$.$mol_state_session.value('a_denominator', val) || 1;
                return result;
            }
            b_nominator(val, force) {
                return this.$.$mol_state_session.value('b_nominator', val) || 0;
            }
            b_denominator(val, force) {
                return this.$.$mol_state_session.value('b_denominator', val) || 1;
            }
            lcm() {
                const result = lcm(this.a_denominator(), this.b_denominator());
                return result;
            }
            a_bis_nominator() {
                const result = this.a_nominator() * this.lcm() / this.a_denominator();
                return result;
            }
            b_bis_nominator() {
                const result = this.b_nominator() * this.lcm() / this.b_denominator();
                return result;
            }
            a_op_b_nominator() {
                const result = this.op_title() === '+' ?
                    this.a_bis_nominator() + this.b_bis_nominator() :
                    this.a_bis_nominator() - this.b_bis_nominator();
                return result;
            }
            gcd() {
                const result = gcd(this.a_op_b_nominator(), this.lcm());
                return result;
            }
            result_nominator() {
                const result = this.a_op_b_nominator() / this.gcd();
                return result;
            }
            result_denominator() {
                const result = this.lcm() / this.gcd();
                return result;
            }
            Eq3() {
                return this.gcd() === 1 ? null : super.Eq3();
            }
            FractionResult() {
                return this.gcd() === 1 ? null : super.FractionResult();
            }
        }
        __decorate([
            $.$mol_mem
        ...
        __decorate([
            $.$mol_mem
        ], $niki4.prototype, "a_op_b_nominator", null);
        __decorate([
            $.$mol_mem
        ], $niki4.prototype, "gcd", null);
        __decorate([
            $.$mol_mem
        ], $niki4.prototype, "result_nominator", null);
        __decorate([
            $.$mol_mem
        ], $niki4.prototype, "result_denominator", null);
        __decorate([
            $.$mol_mem
        ], $niki4.prototype, "Eq3", null);
        __decorate([
        ...
        $$.$niki4 = $niki4;
        class $niki4_op_input extends $.$niki4_op_input {
            title() {
                return this.checked() ? '-' : '+';
            }
        }
        __decorate([
            $.$mol_mem
        ], $niki4_op_input.prototype, "title", null);
        $$.$niki4_op_input = $niki4_op_input;
        function lcm(x, y) {
